...
const Aviator = () => {
    ...
    return (
        <>
            <TopLogoBar loaded={loaded} setSettingModalOpen={setSettingModalOpen} setHistoryModalOpen={setHistoryModalOpen} setRuleModalOpen={setRuleModalOpen} setChatOpen={setChatOpen} />
            {
                aviatorState.auth ?
                    (openGame && loaded ?
                        <GameBoard bet6={bet6} chatParam={{ chatOpen, setChatOpen }} />
                        :
