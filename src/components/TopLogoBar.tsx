...
const TopLogoBar = ({ loaded, setSettingModalOpen, setHistoryModalOpen, setRuleModalOpen, setChatOpen }: { loaded: boolean, setSettingModalOpen: React.Dispatch<React.SetStateAction<boolean>>, setHistoryModalOpen: React.Dispatch<React.SetStateAction<boolean>>, setRuleModalOpen: React.Dispatch<React.SetStateAction<boolean>>, setChatOpen: React.Dispatch<React.SetStateAction<boolean>> }) => {
