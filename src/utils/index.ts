...
export const renderCurve = (g: Graphics, _dimension: dimensionType) => {
    ...
    g.lineStyle(lineWidth, 0xe50539, 1);
    g.moveTo(points[0].x, points[0].y);
...
export const initBet6 = JSON.parse(localStorage.getItem(`bet6`) || '["10","20","50","100"]')
export const webpORpng = "png" // utils.isWebGLSupported() ? "webp" : "png" //!TODO